...
export class EmailTemplateComponent implements OnInit {
  ...
  async ngOnInit(): Promise<void> {
    ...
    this.variables = [
      ...
      { code: 'section', description: this.t._('EMAIL_TEMPLATE.VARIABLES.SECTION') },
      { code: 'spotType', description: this.t._('EMAIL_TEMPLATE.VARIABLES.SPOT_TYPE') },
      { code: 'spotId', description: this.t._('EMAIL_TEMPLATE.VARIABLES.SPOT_ID') },
      { code: 'price', description: this.t._('EMAIL_TEMPLATE.VARIABLES.PRICE') },
